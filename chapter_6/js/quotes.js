...
//div#quote 내부의 span 태그 두개를 first-child와 last-child로 가져옴.

const todaysQuote = quotes[Math.floor(Math.random() * quotes.length)];
//Math.round(1.1) -> 1 (반올림))
//Math.ceil(1.1) -> 2 (올림)
//Math.floor(1.1) -> 1 (내림)
//Array.length -> Array의 길이를 반환해줌

quote.innerText = todaysQuote.quote;
//quotes를 값으로 갖고 있는 todaysQuote는 quote와 author를 object로 갖고 있음.
//따라서 todaysQuote 중 quote object를 추출하기 위해 todaysQuote.quote를 작성.
